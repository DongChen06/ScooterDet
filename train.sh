...
cd D:/ScooterDet/yolov5; C:\Users\David\miniconda3\envs\escooter  train.py --img 640 --device 0 --batch 16 --epochs 100 --data scooter.yaml --weights yolov5n.pt
cd D:/ScooterDet/yolov5; C:\Users\David\miniconda3\envs\escooter  train.py --img 640 --device 0 --batch 16 --epochs 100 --data scooter.yaml --weights yolov5s.pt
cd D:/ScooterDet/yolov5; C:\Users\David\miniconda3\envs\escooter train.py --img 640 --device 0 --batch 16 --epochs 100 --data scooter.yaml --weights yolov5m.pt
cd D:/ScooterDet/yolov5; C:\Users\David\miniconda3\envs\escooter  train.py --img 640 --device 0 --batch 16 --epochs 100 --data scooter.yaml --weights yolov5l.pt
cd D:/ScooterDet/yolov5; C:\Users\David\miniconda3\envs\escooter  train.py --img 640 --device 0 --batch 16 --epochs 100 --data scooter.yaml --weights yolov5x.pt
